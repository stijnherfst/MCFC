...
// 			if (modes[GetPlayerId(GetTriggerPlayer())] === Mode.load) {
...
// 		}
// 		BlzFrameSetText(title, modes[GetPlayerId(GetTriggerPlayer())] === Mode.load ? "Load Character" : "Save Character")
// 	}
// }
...
// 			modes[GetPlayerId(GetTriggerPlayer())] = Mode.load
// 			refreshData()
// 			toggleVisibility()
// 		});
// 	}
...
// 		TriggerAddAction(trigger, () => {
// 			modes[GetPlayerId(GetTriggerPlayer())] = Mode.save
// 			refreshData()
// 			toggleVisibility()
// 		});
// 	}
